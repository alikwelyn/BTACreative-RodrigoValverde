      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 text-center">
            <a href="<?php echo $button_expertise_areas_section['link_button_expertise_areas_section']; ?>" class="btn btn_default"><?php echo $button_expertise_areas_section['text_button_expertise_areas_section']; ?></a>
          </div>
        </div>
      </div>
